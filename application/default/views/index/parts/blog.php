        ...
        <div class="blogs mb-5">
            <div class="row">
                ...
                <div class="col">
                    <div class="border border-light shadow border-blog mx-1" style="max-width: 290px;">
                        <div class="d-flex justify-content-center bor">
                            <a href=""><img src="<?= $this->_dirImg ?>testt.jpg" class="card-img-top img-fluid cs-zoom-img" style="width: 300px; height: 200px" alt="..."></a>
                        </div>
                        <div class="card-body">
                            <a href="">
                ...
                <div class="col">
                    <div class="border border-light shadow border-blog mx-1" style="max-width: 290px;">
                        <div class="d-flex justify-content-center bor">
                            <a href=""><img src="<?= $this->_dirImg ?>testt2.png" class="card-img-top img-fluid cs-zoom-img" style="width: 300px; height: 200px" alt="..."></a>
                        </div>
                        <div class="card-body">
                            <a href="">
                                <h6 title="Top 5 kênh youtube Việt truyền cảm hứng và năng lượng tích cực cho giới trẻ" class="card-title title-job cs-ellipsis-2 pb-1">Top 5 kênh youtube Việt truyền cảm hứng và năng lượng tích cực cho giới trẻ</h6>
                ...
                <div class="col">
                    <div class="border border-light shadow border-blog mx-1" style="max-width: 290px;">
                        <div class="d-flex justify-content-center bor">
                            <a href=""><img src="<?= $this->_dirImg ?>testt3.jpg" class="card-img-top img-fluid cs-zoom-img" style="width: 300px; height: 200px" alt="..."></a>
                        </div>
                        <div class="card-body">
                            <a href="">
                                <h6 title="Top 5 kênh youtube Việt truyền cảm hứng và năng lượng tích cực cho giới trẻ" class="card-title title-job cs-ellipsis-2 pb-1">Top 5 kênh youtube Việt truyền cảm hứng và năng lượng tích cực cho giới trẻ</h6>
