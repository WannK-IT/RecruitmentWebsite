            ...
            <div class="row mb-5 d-flex justify-content-center" style="background: radial-gradient(rgba(13, 110, 253, .06), white);">
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/it.png" alt="jobit"></a>
                ...
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/marketing.png" alt="jobmarketing"></a>
                ...
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/business.png" alt="jobbusiness"></a>
                ...
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/technique.png" alt="jobtechnique"></a>
                ...
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/accounting.png" alt="jobaccounting"></a>
                ...
                <div class="card shadow-sm border-1 cs-list-job mx-3" style="width: 10rem;">
                    <div class="card-body text-center">
                        <a href=""><img src="<?= $this->_dirImg ?>listjob/economic.png" alt="jobeconomic"></a>
