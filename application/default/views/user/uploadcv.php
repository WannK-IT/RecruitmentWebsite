...
if (!empty($this->getCV['fileCV'])) {
    ...
    $btnDeleteCV .= '<div class="mt-3 mx-1" id="deleteCV">
                        <a href="' . $href . '" style="width: 110px" class="btn bg-red text-white">
                ...
                <div class="col-12">
                    <form class="form-horizontal" method="post" id="form-upload-cv" enctype="multipart/form-data">
                        <div class="mt-2 d-flex justify-content-center">
                            <label for="upload_cv" role="button" style="width: 110px" class="btn bg-purple fw-bold mt-3 mx-1 text-white">
