<?php 
    $row_1 = [
        [
            ...
            'input' => FormFrontEnd::inputRow('text', 'position', '', true)
        ]
    ];
    $row_2 = [
        [
            'label' => FormFrontEnd::labelRow('level', 'Trình độ học vấn', true),
            'input' => FormFrontEnd::selectBoxRow('level',  $this->level, '', true)
        ],
        [
            'label' => FormFrontEnd::labelRow('gender', 'Giới tính', true),
            'input' => FormFrontEnd::selectBoxRow('gender', $this->gender, '', true)
        ],
        [
            'label' => FormFrontEnd::labelRow('exp', 'Kinh nghiệm làm việc', false),
            'input' => FormFrontEnd::selectBoxRow('exp', $this->exp, '', false)
        ],
    ];
    $row_3 = [
        [
            'label' => FormFrontEnd::labelRow('marriage', 'Tình trạng hôn nhân', false),
            'input' => FormFrontEnd::selectBoxRow('marriage', $this->marriage, '', false)
        ],
        [
            'label' => FormFrontEnd::labelRow('city', 'Tỉnh/Thành phố', true),
            'input' => FormFrontEnd::selectBoxRow('city', $this->city, '', true)
        ],
    ];
    $row_4 = [
        [
            'label' => FormFrontEnd::labelRow('career', 'Ngành nghề', true),
            'input' => FormFrontEnd::selectBoxRow('career', $this->career, '', true)
        ],
        [
            'label' => FormFrontEnd::labelRow('workplace', 'Nơi làm việc mong muốn', true),
            'input' => FormFrontEnd::selectBoxRow('workplace', $this->city, '', true)
        ],
    ];
    $row_5 = [
        [
            'label' => FormFrontEnd::labelRow('birthday', 'Ngày sinh', true),
            'input' => FormFrontEnd::inputRow('date', 'birthday', '', true)
        ],
        [
            'label' => FormFrontEnd::labelRow('address', 'Địa chỉ', true),
            'input' => FormFrontEnd::inputRow('text', 'address', '', true)
        ],
    ];
    $row_6 = [
        [
            'label' => FormFrontEnd::labelRow('hard_skl', 'Kỹ năng chuyên môn (Kỹ năng cứng)', true),
            'input' => FormFrontEnd::textareaRow('hard_skl', '', true)
        ]
    ];
    $row_7 = [
        [
            'label' => FormFrontEnd::labelRow('soft_skl', 'Kỹ năng xã hội (Kỹ năng mềm)', true),
            'input' => FormFrontEnd::textareaRow('soft_skl', '', true)
        ]
    ];
    $row_8 = [
        [
            'label' => FormFrontEnd::labelRow('rank', 'Cấp bậc', true),
            'input' => FormFrontEnd::selectBoxRow('rank', $this->rank, '', true)
        ],
        [
            'label' => FormFrontEnd::labelRow('salary', 'Mức lương', false),
            'input' => FormFrontEnd::selectBoxRow('salary', $this->salary, '', false)
        ],
        [
            'label' => FormFrontEnd::labelRow('type_work', 'Loại hình làm việc', false),
            'input' => FormFrontEnd::selectBoxRow('type_work', $this->typeWork, '', false)
        ],
    ];
    $row_9 = [
        [
            'label' => FormFrontEnd::labelRow('career_goals', 'Mục tiêu nghề nghiệp', true),
            'input' => FormFrontEnd::textareaRow('career_goals', '', true)
        ]
    ];
    $row_10 = [
        [
            'label' => FormFrontEnd::labelRow('exp_work', 'Kinh nghiệm làm việc', true),
            'input' => FormFrontEnd::textareaRow('exp_work', '', true)
        ]
    ];
    $row_11 = [
        [
            'label' => FormFrontEnd::labelRow('degree', 'Học vấn bằng cấp', true),
            'input' => FormFrontEnd::textareaRow('degree', '', true)
        ]
    ];
