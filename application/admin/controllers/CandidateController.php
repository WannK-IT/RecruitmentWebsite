...
class CandidateController extends Controller
{
    ...
    public function findAction()
    {
        ...
        $this->_view->candidates    = $this->_model->listCandidates($this->_arrParam, 'actionFind');
        $this->_view->total         = $this->_model->totalCandidates($this->_arrParam);
        $this->_view->saved         = $this->_model->saveProfile($this->_arrParam, 'list');
    ...
    public function listAction()
    {
        ...
        $this->_view->candidates    = $this->_model->listCandidates($this->_arrParam, 'actionList');
    ...
    {
        $this->_view->setTitle('Danh sách hồ sơ ứng viên đã lưu');
        $this->_view->candidates    = $this->_model->listCandidates($this->_arrParam, 'actionSaved');
        $this->_view->total         = $this->_model->totalSavedProfile();
    ...
    {
        $result = $this->_model->saveProfile($this->_arrParam, 'save');
        echo json_encode($result);
    }

    public function deleteSaveProfileAction(){
        $this->_model->deleteSaveProfile($this->_arrParam);
        URL::direct('admin', 'candidate', 'saved');
    }
}
