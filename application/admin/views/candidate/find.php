<?php
$selectBoxTypeWork      = FormBackEnd::selectBoxAccount('typework_search', $this->type_work, @$this->arrParam['typework_search'], false);
                ...
                <form action="" id="formSearch" method="GET">
                    ...
                    <div class="row">
                        <div class="col-md-3 border-right">
                            <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
                                <div class="d-flex justify-content-between pb-3 mb-3 link-dark text-decoration-none border-bottom">
                                    ...
                                    <a href="<?= URL::addLink($this->arrParam['module'], $this->arrParam['controller'], 'find') ?>" class="text-info">Xóa bộ lọc</a>
                                </div>
                                <ul class="list-unstyled pl-0">
                                    <li class="mb-2">
                                        <button class="btn btn-toggle align-items-center rounded" data-toggle="collapse" data-target="#profile-collapse1" aria-expanded="false">Hình thức làm việc</button>
                                        <div class="collapse show" id="profile-collapse1">
                                    ...
                                    <li class="mb-2">
                                        <button class="btn btn-toggle align-items-center rounded" data-toggle="collapse" data-target="#profile-collapse2" aria-expanded="false">Địa điểm</button>
                                    ...
                                    <li class="mb-2">
                                        <button class="btn btn-toggle align-items-center rounded" data-toggle="collapse" data-target="#profile-collapse3" aria-expanded="false">Bằng cấp</button>
                                    ...
                                    <li class="mb-2">
                                        <button class="btn btn-toggle align-items-center rounded" data-toggle="collapse" data-target="#profile-collapse4" aria-expanded="false">Giới tính</button>
                                    ...
                                    <li class="mb-2">
                                        <button class="btn btn-toggle align-items-center rounded" data-toggle="collapse" data-target="#profile-collapse5" aria-expanded="false">Kinh nghiệm</button>
                        ...
                        <div class="col-md-9 p-3">
                            <p class="font-weight-bold h5">Kết quả tìm thấy: <span class=""><?= @$this->total ?> ứng viên</span></p>
                            <?php
                            $keyword = '';
