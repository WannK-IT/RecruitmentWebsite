...
$thumb = (!empty($data['news_thumbnail'])) ? THUMB_URL_ADMIN . $_SESSION['login']['idUser'] . DS . $data['news_thumbnail'] : IMG_URL_ADMIN . 'thumbnail_default.png';
?>
<div class="row d-flex justify-content-center pt-2">
    ...
    <div class="col-md-8">
        <div class="card mb-2 p-4 mb-4">
            ...
            <img src="<?= $thumb ?>" class="img-fluid mx-auto pb-4" style="max-height: 500px" alt="logo_news">
            <div>
